...
import net.mrsterner.grandecuisine.items.GuiItem;
...
public class GrandeCuisine implements ModInitializer {
   ...
   //public static BlockEntityType<BarrelBlockEntity> BARREL_BLOCK_ENTITY;
    ...
    public void onInitialize() {
        ...
        //BARREL_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, "grandecuisine", BlockEntityType.Builder.create(BarrelBlockEntity::new, BARREL_BLOCK).build(null));
        //RENDER
